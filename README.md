...
- `api-route-gate_safe.wave` — the correct design.
- `api-route-gate_unsafe.wave` — the tempting-but-wrong version (the negative example a model must learn to reject).
